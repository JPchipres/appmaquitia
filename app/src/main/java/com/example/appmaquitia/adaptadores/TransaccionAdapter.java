...
public class TransaccionAdapter extends ArrayAdapter<Transaccion> {
    ...
    public TransaccionAdapter(@NonNull Context context, ArrayList<Transaccion> dataModalArrayList){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listitemView == null) {
            listitemView = LayoutInflater.from(getContext()).inflate(R.layout.cardtransaccion, parent, false);
        }
        ...
        TextView oscTV = listitemView.findViewById(R.id.osc);
        ...
        oscTV.setText("Asociacion: "+dataModal.getNombre());
